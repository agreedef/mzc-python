...
class Car:
    car_image = ['Car01.png', 'Car02.png', 'Car03.png', 'Car04.png', 'Car05.png', 'Car06.png', 'Car07.png', 'Car08.png', 'Car09.png', 'Car10.png', 'Car11.png', 'Car12.png', 'Car13.png', 'Car14.png', 'Car15.png', 'Car16.png', 'Car17.png', 'Car18.png', 'Car19.png',
                 'Car20.png', 'Car21.png', 'Car22.png', 'Car23.png', 'Car24.png', 'Car25.png', 'Car26.png', 'Car27.png', 'Car28.png', 'Car29.png', 'Car30.png', 'Car31.png', 'Car32.png', 'Car33.png', 'Car34.png', 'Car35.png', 'Car36.png', 'Car37.png', 'Car38.png', 'Car39.png', 'Car40.png']
    ...
    def load_car(self, p = ""):
        if p == "p":
            ...
            # 이미지 크기 조절 - 이미지 마다 크기가 다 다르므로 가로 세로 비율 유지하면서 변경
            ...
            # 다양한 속도 차이를 위해 5 ~ speed 사이에서 랜덤으로 속도를 선택하게 합니다.
            speed = STAGE + 5
            if speed > 15:
                speed = 15
...
def main():
    ...
    SCREEN = pygame.display.set_mode(
        (WINDOW_WIDTH, WINDOW_HEIGHT), pygame.HWSURFACE | pygame.DOUBLEBUF | pygame.RESIZABLE)
    pygame.display.set_caption("Racing Car Game")
    # 투명 아이콘은 32 x 32 로 해야 적용됨
    ...
    while playing:
        for event in pygame.event.get():
            ...
            # 화살표 키를 이용해서 플레이어의 움직임 거리를 조정해 준다.
